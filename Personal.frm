...
Begin VB.Form frmPersonal 
   ...
   Begin MSAdodcLib.Adodc adoPersonal 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM Personal where Codigo > 0 ORDER BY Nombre"
      Caption         =   "Adodc1"
   ...
   Begin VB.ComboBox txtCalificacion1 
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "Personal.frx":0446
      Left            =   4920
      List            =   "Personal.frx":0448
      TabIndex        =   36
      Top             =   2640
      Width           =   1575
   End
   ...
   Begin VB.ComboBox txtNombre 
      ...
      DataSource      =   "Personal"
      Height          =   315
      ItemData        =   "Personal.frx":044A
      Left            =   1680
      List            =   "Personal.frx":044C
      TabIndex        =   1
      Top             =   90
      Width           =   6255
   End
   ...
   Begin VB.ComboBox cmbDocumentoTipo 
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "Personal.frx":044E
      Left            =   2280
      List            =   "Personal.frx":0450
      TabIndex        =   14
      Text            =   "CUIL"
      Top             =   1170
      Width           =   855
...
Private Sub Form_Load()
    ...
    rstPersonal.Open "SELECT Codigo, Nombre FROM Personal WHERE Codigo>0 ORDER BY Nombre", Conexion, adOpenKeyset, adLockOptimistic, adCmdText
...
Private Sub Form_Activate()
    txtNombre.Clear
    rstPersonal.Close
    rstPersonal.Open "SELECT Nombre FROM Personal WHERE Codigo > 0 ORDER BY Nombre", Conexion, adOpenKeyset, adLockOptimistic, adCmdText
    rstPersonal.Requery
    While rstPersonal.EOF = False
...
Private Sub cmdNuevo_Click()
    rstPersonal.Close
    rstPersonal.Open "SELECT * FROM Personal where Codigo > 0 ORDER BY Codigo", Conexion, adOpenKeyset, adLockOptimistic, adCmdText
    NuevoCodigo = 0
    If rstPersonal.RecordCount > 0 Then
        For i = 1 To rstPersonal.RecordCount
    ...
    dbgPersonal.Enabled = False
    'blanqueo campos
    txtNombre.Text = ""
    txtDocumentoNumero.Text = ""
    txtFoja.Text = ""
    txtFechaNac.Text = "01/01/2000"
    txtLugar.Text = ""
    txtDomicilio.Text = ""
    txtLocalidad.Text = ""
...
Private Sub txtDocumentoNumero_Change()
    txtUsuario = txtDocumentoNumero
End Sub
...
Private Sub AutoLoad()
    rstPersonal.Close
    rstPersonal.Open "SELECT * FROM Personal WHERE Codigo > 0 ORDER BY Nombre", Conexion, adOpenKeyset, adLockOptimistic, adCmdText
    txtSexo.Text = ""
    txtFechaNac.Text = ""
    txtFoja.Text = ""
    txtLugar.Text = ""
